...
const computeFewestSteps = require("../src/day03/day03").computeFewestSteps;
...
describe("Day 3", () => {
  ...
  it("should compute the correct number of steps for batch 1", () => {
    const input1 = 'R75,D30,R83,U83,L12,D49,R71,U7,L72';
    const input2 = 'U62,R66,U55,R34,D71,R55,D58,R83';
    expect(computeFewestSteps(input1, input2)).to.equal(610);
  });

  it("should compute the correct number of steps for batch 2", () => {
    const input1 = 'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51';
    const input2 = 'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7';
    expect(computeFewestSteps(input1, input2)).to.equal(410);
  });
});
